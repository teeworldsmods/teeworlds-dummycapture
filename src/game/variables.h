...
MACRO_CONFIG_INT(SvScorelimit, sv_scorelimit, 500, 0, 1000, CFGFLAG_SERVER, "Score limit (0 disables)")
MACRO_CONFIG_INT(SvTimelimit, sv_timelimit, 0, 0, 1000, CFGFLAG_SERVER, "Time limit in minutes (0 disables)")

// Dummy
MACRO_CONFIG_INT(SvRespawnDelay, sv_respawn_delay, 3, 0, 10, CFGFLAG_SERVER, "Time needed to respawn after death")
